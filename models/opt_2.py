...
def optimize_mckinsey(train):
    ...
    B_ineq = [50000 * 3865/890, -5000 * 3865/890]
...
pred_opt = optimize_mckinsey(train)

train['pred_opt'] = pred_opt
train.to_csv('/Users/onurerkinsucu/Dev/prohack/data/interim/train_with_pred_opt.csv', index=False)

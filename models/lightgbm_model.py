...
#     params, d_train, verbose_eval=100, early_stopping_rounds=100, folds=KFold(n_splits=5)
# )
#
# tuner.run()

# cv_dict = lgb.cv(params, d_train, num_boost_round=3000, folds=None, nfold=5, stratified=False, shuffle=False, metrics=None, fobj=None, feval=None, init_model=None, feature_name='auto', categorical_feature=cate_cols, early_stopping_rounds=100, fpreproc=None, verbose_eval=10, show_stdv=False, seed=0, callbacks=None, eval_train_metric=True)
...
X_test_pred.to_csv('/Users/onurerkinsucu/Dev/prohack/data/processed/X_test_pred_21_may_lgb.csv', index=False)

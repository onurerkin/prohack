...
# params={'num_leaves': 18, 'feature_fraction': 0.9242398025602147, 'bagging_fraction': 0.5704142185125258, 'bagging_freq': 2, 'min_child_samples': 61}
...
cv_dict = lgb.cv(params, d_train, num_boost_round=3000, folds=None, nfold=10, stratified=False, shuffle=False,
                 metrics=None, fobj=None, feval=None, init_model=None, feature_name='auto',
                 categorical_feature=cate_cols, early_stopping_rounds=100, fpreproc=None, verbose_eval=10,
                 show_stdv=False, seed=0, callbacks=None, eval_train_metric=True)
